...
public class MCAATest {
    ...
    public void testMCAAScoring_TimeWeightDominates() {
        ...
        assertTrue(score1 > score2, "Proposal 1 should have higher score due to shorter delivery time. " + "Score1=" + score1 + ", Score2=" + score2);
    }
    ...
    public void testMCAAScoring_IdenticalProposals() {
        ...
        double score1 = MCAA.computeScore(testOrder, proposal1);
        double score2 = MCAA.computeScore(testOrder, proposal2);
        assertEquals(score1, score2, 0.001, "Identical proposals should have identical scores");
    }
    ...
    public void testMCAAScoring_HighReliabilityWins() {
        ...
        double score1 = MCAA.computeScore(testOrder, proposal1);
        double score2 = MCAA.computeScore(testOrder, proposal2);
        assertTrue(score1 > score2, "Higher reliability should result in higher score");
    }
    ...
    public void testMCAAScoring_LowPriceCanWin() {
        ...
        double score1 = MCAA.computeScore(testOrder, proposal1);
        double score2 = MCAA.computeScore(testOrder, proposal2);
        assertTrue(score1 > score2, "Faster delivery should win despite higher price with default weights");
    }
}