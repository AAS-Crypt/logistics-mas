...
public class SPTATest {
    ...
    public void testSPTA_PolicyUpdate() {
        ...
        assertTrue(newPolicy.get("mcaa.weight.cost") > currentPolicy.get("mcaa.weight.cost"),
            "Cost weight should increase when avg_cost > 1000");
        assertTrue(newPolicy.get("mcaa.weight.time") > currentPolicy.get("mcaa.weight.time"),
            "Time weight should increase when avg_delivery_time > 24");
    }
}