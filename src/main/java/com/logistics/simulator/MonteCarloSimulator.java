...
public class MonteCarloSimulator {
    ...
    private static void runSimulation(int iterations, String uncertaintyLevel) {
        ...
        Logger.info("MonteCarloSimulator", "  Cost: $" + String.format("%.2f", avgCost - 1.96 * costStdDev) + 
                   " to $" + String.format("%.2f", avgCost + 1.96 * costStdDev));
        Logger.info("MonteCarloSimulator", "  Time: " + String.format("%.1f", avgTime - 1.96 * timeStdDev) + 
                   " to " + String.format("%.1f", avgTime + 1.96 * timeStdDev) + " hours");
    }
