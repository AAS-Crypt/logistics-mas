...
public class LogisticsSimulator {
    ...
    public void run(int numOrders, int numResources, int durationMinutes) {
        Logger.info("Simulator", "Starting simulation: " + numOrders + " orders, " + numResources + " resources, " + durationMinutes + " minutes");
    ...
    public void reportKPIs() {
        ...
        Logger.info("Simulator", "Completion Rate: " + (totalOrders > 0 ? (completedOrders * 100.0 / totalOrders) : 0) + "%");
        Logger.info("Simulator", "Average Delivery Time: " + (completedOrders > 0 ? (totalDeliveryTime / completedOrders) : 0) + " hours");
        Logger.info("Simulator", "Average Cost: " + (completedOrders > 0 ? (totalCost / completedOrders) : 0));
