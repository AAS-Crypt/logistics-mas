...
public class QLearning {
    ...
    private Action getBestAction(State state) {
        ...
        String bestActionKey = Collections.max(actions.entrySet(), Map.Entry.comparingByValue()).getKey();
    ...
    private double calculateReward(State state, TrainingExample example) {
        double score = state.costWeight * example.costScore + state.timeWeight * example.timeScore + state.reliabilityWeight * example.reliabilityScore;
        return score;
    }
