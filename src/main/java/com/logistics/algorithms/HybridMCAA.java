...
public class HybridMCAA {
    ...
    public static Map<Integer, Integer> optimizeMCAA_GA(List<Order> orders, Map<Integer, List<Proposal>> proposals) {
    ...
    public static Map<Integer, Integer> optimizeMCAA_SA(List<Order> orders, Map<Integer, List<Proposal>> proposals) {
        Map<Integer, Integer> initialSolution = getMCAASolution(orders, proposals);
        Map<Integer, Integer> refinedSolution = refineWithSA(orders, proposals, initialSolution);
        return refinedSolution;
    }
     
    public static Map<Integer, Integer> optimizeMCAA_PSO(List<Order> orders, Map<Integer, List<Proposal>> proposals) {
        Map<Integer, Integer> initialSolution = getMCAASolution(orders, proposals);
        Map<Integer, Integer> refinedSolution = refineWithPSO(orders, proposals, initialSolution);
        return refinedSolution;
    }
     
    public static Map<Integer, Integer> optimizeAdaptive(List<Order> orders, Map<Integer, List<Proposal>> proposals) {
    ...
    private static Map<Integer, Integer> getMCAASolution(List<Order> orders, Map<Integer, List<Proposal>> proposals) {
    ...
    private static Map<Integer, Integer> refineWithGA(List<Order> orders, Map<Integer, List<Proposal>> proposals, Map<Integer, Integer> initialSolution) {
    ...
    private static Map<Integer, Integer> refineWithSA(List<Order> orders, Map<Integer, List<Proposal>> proposals, Map<Integer, Integer> initialSolution) {
    ...
    private static Map<Integer, Integer> refineWithPSO(List<Order> orders, Map<Integer, List<Proposal>> proposals, Map<Integer, Integer> initialSolution) {
    ...
    private static double calculateTotalScore(List<Order> orders, Map<Integer, List<Proposal>> proposals, Map<Integer, Integer> allocation) {
        double totalScore = 0;
        for (int i = 0; i < orders.size(); i++) {
