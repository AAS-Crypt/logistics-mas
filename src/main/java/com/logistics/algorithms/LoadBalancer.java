...
public class LoadBalancer {
    ...
    public void updateContainerMetrics(String containerId, int agentCount, double cpuUsage, double memoryUsage, double networkLatency) {
    ...
    public boolean needsRebalancing() {
        ...
        double maxLoad = Collections.max(containers, Comparator.comparingDouble(Container::getLoadScore)).getLoadScore();
        double minLoad = Collections.min(containers, Comparator.comparingDouble(Container::getLoadScore)).getLoadScore();
