...
public class RealWorldAlgorithmTest {
    ...
    private static class RealWorldScenario {
        ...
        RealWorldScenario(String name, String description, List<String> warehouses,
                         List<String> customers, double budgetMultiplier, 
                         double timeMultiplier, int numOrders) {
            this.name = name;
    ...
    private static AlgorithmResult runHybridMCAA_GA(List<Order> orders,
                                                    Map<Integer, List<Proposal>> proposals,
                                                    RealWorldScenario scenario) {
    ...
    private static AlgorithmResult runHybridMCAA_SA(List<Order> orders,
                                                    Map<Integer, List<Proposal>> proposals,
                                                    RealWorldScenario scenario) {
    ...
    private static AlgorithmResult runHybridMCAA_PSO(List<Order> orders,
                                                     Map<Integer, List<Proposal>> proposals,
                                                     RealWorldScenario scenario) {
    ...
    private static AlgorithmResult runHybridAdaptive(List<Order> orders,
                                                     Map<Integer, List<Proposal>> proposals,
                                                     RealWorldScenario scenario) {
    ...
    private static void printScenarioSummary(RealWorldScenario scenario, 
    ...
    private static void generateReport(Map<String, Map<String, AlgorithmResult>> allResults,
                                      List<RealWorldScenario> scenarios) {
        String timestamp = new SimpleDateFormat("yyyyMMdd_HHmmss").format(new Date());
        String filename = "real_world_algorithm_report_" + timestamp + ".html";
