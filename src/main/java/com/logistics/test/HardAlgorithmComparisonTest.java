...
public class HardAlgorithmComparisonTest {
    ...
    private static Map<String, AlgorithmResult> runHardScenarioTest(TestScenario scenario) {
        ...
        System.out.println("Generating " + scenario.numOrders + " orders with " + PROPOSALS_PER_ORDER + " proposals each...");
    ...
    private static void generatePDFReport(Map<String, Map<String, AlgorithmResult>> allResults, List<TestScenario> scenarios) {
        ...
        String htmlFilename = "overall_test_reports\\hard_algorithm_comparison_report_" + timestamp + ".html";
        String pdfFilename = "overall_test_reports\\hard_algorithm_comparison_report_" + timestamp + ".pdf";
        try {
