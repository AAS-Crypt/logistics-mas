...
class ResearchAnalyzer:
    def __init__(self, input_dir="./overall_test_reports/research_data", output_dir="./research_reports"):
    ...
    def generate_report(self, output_file=datetime.now().strftime("%Y%m%d_%H%M%S")+"_research_report.md"):
...
def main():
    ...
    parser.add_argument("--input_dir", default="./overall_test_reports/research_data", help="Input directory with log files")
    parser.add_argument("--output_dir", default="./overall_test_reports/research_reports", help="Output directory for reports")
